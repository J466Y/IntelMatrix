...
<head>
    ...
    <title>Kirol Leaky | Central Threat Intelligence Platform</title>
    ...
    <div class="container-fluid">
      <div class="masthead">
        <div class="d-flex justify-content-between align-items-center mb-4 px-2">
            <a href="/leaksearch" style="text-decoration: none;"><h3 class="brand-logo m-0">Kirol Intel_</h3></a>
            ...
            <ul class="navbar-nav nav-justified w-100">
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownSearch">
                  ...
                  <div class="dropdown-divider" style="border-color: #2a2a2a;"></div>
                  <a class="dropdown-item" href="/leaksearch">Leak Search (API)</a>
                </div>
              </li>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu" aria-labelledby="navbarDropdownMisc">
                  ...
                  <a class="dropdown-item" href="/hostname-check">Hostname Checker</a>
                </div>
              </li>
